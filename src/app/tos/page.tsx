...
export default function Page() {
  return (
    <main className="mx-auto max-w-prose space-y-6 p-3 py-6">
      ...
      <p>
        Welcome to Resume Craft. These Terms of Service (&quot;Terms&quot;)
        govern your use of our website and services, including any paid
        subscription plans. By accessing or using Resume Craft (&quot;the
        Service&quot;), you agree to be bound by these Terms. If you do not
        agree to these Terms, do not use the Service.
      </p>
      <h2 className="text-xl font-semibold">1. Overview</h2>
      <p>
        Resume Craft is a SaaS platform that provides resume-building tools
      ...
      <ul className="list-inside list-disc">
        ...
        <li>
          <strong>Refund Policy:</strong> Resume Craft does not offer
      ...
      <p>
        Resume Craft grants you a limited, non-exclusive, non-transferable,
      ...
      <p>
        ...
        Resume Builder are owned by Resume Craft or its licensors. You
        agree not to infringe on these rights.
      </p>
      <h2 className="text-xl font-semibold">10. User Content</h2>
      <p>
        By using the Service, you grant Resume Craft a non-exclusive,
      ...
      <p>
        ...
        services (e.g., Stripe for payments). Resume Craft is not
      ...
      <p>
        ...
        available&quot; basis. Resume Craft makes no warranties, express or
      ...
      <p>
        To the fullest extent permitted by law, Resume Craft shall not be
      ...
      <p>
        By using Resume Craft, you acknowledge that you have read,

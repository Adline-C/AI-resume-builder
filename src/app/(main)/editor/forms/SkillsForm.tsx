    ...
    return <div className="max-w-xl mx-auto space-y-6">
        <div className="space-y-1.5 text-center">
            <h2 className="text-2xl font-semibold">
                Skills
            </h2> <p className="text-sm text-muted-foreground">What are you good at?</p>
        </div>
        <Form {...form}>
            <form className="space-y-3">
                ...
                render={({field}) => (
                    <FormItem>
                        ...
                        <FormControl>
                            <Textarea 
                            {...field} placeholder="eg: Technical skills (eg:python,java) and soft skills (eg: leadership,innovative)."
                            onChange={(e) => {

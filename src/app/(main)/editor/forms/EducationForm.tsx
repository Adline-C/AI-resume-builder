        ...
        <FormProvider {...form}>
            <div className="max-w-xl mx-auto space-y-6">
                <div className="space-y-1.5 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">Add about your previous educations if you have any.</p>
                </div>
                <form onSubmit={form.handleSubmit((data) => console.log(data))} className="space-y-3">
                <DndContext 
                    sensors={sensors}
...
interface EducationItemProps {
    id: string;
    form: UseFormReturn<EducationValues>; // Ensure the interface matches
    index: number;
...
function EducationItem({ id, form, index, remove }: EducationItemProps) {
    ...
    return (
        ...
        ref={setNodeRef} style={{ transform:CSS.Transform.toString(transform),
                    transition}}>

...
export default function SummaryForm({resumeData,setResumeData}:EditorFormProps){
    ...
    return <div className="max-w-xl mx-auto space-y-6">
        <div className="space-y-1.5 text-center">
            ...
            <p className="text-sm text-muted-foreground">Write a short introduction for your resume or let the AI generate one from your entered data.</p>
        </div>
        <Form {...form}>
            <form className="space-y-3">
                ...
                render={({field}) => (
                    <FormItem>
                        ...
                        <FormControl>
                            <Textarea
                            {...field} placeholder="A brief engaging paragraph about yourself"
                            />
                        </FormControl>
